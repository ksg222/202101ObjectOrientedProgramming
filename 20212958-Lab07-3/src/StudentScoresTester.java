...
public class StudentScoresTester {
	public static void main(String[] args) {
		...
		/** And here */
		System.out.println("Student with highest score: name=" + studSc.getHighest().name + " score=" + studSc.getHighest().score);
		System.out.println("Student with lowest score: name=" + studSc.getLowest().name + " score=" + studSc.getLowest().score);
	}
}